                                             ...
                                             psa_hash_operation_t *target_operation)
{
    ...
    if ((target_operation != NULL) && (target_operation->handle != 0U)) {
                                               ...
                                               size_t *ciphertext_length)
{
    ...
    if ((additional_data == NULL) && (additional_data_length != 0U)) {
                                              ...
                                              size_t *tag_length)
{
    ...
    if ((out_len == 3U) && (ciphertext_length == NULL)) {
        return PSA_ERROR_INVALID_ARGUMENT;
    }
                                              ...
                                              size_t tag_length)
{
    ...
    /* Sanitize the optional output */
    if ((plaintext == NULL) && (plaintext_size != 0U)) {
        return PSA_ERROR_INVALID_ARGUMENT;
    }
    ...
    if ((out_len == 2U) && (plaintext_length == NULL)) {
        return PSA_ERROR_INVALID_ARGUMENT;
    }
