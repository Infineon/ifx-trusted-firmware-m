 ...
 * Copyright (c) 2023-2025 Cypress Semiconductor Corporation (an Infineon
...
#define PLATFORM_SERVICE_INPUT_BUFFER_SIZE     64U
#endif
...
#if (!defined(ATTEST_TOKEN_PROFILE_PSA_2_0_0)) && \
    (!defined(ATTEST_TOKEN_PROFILE_ARM_CCA))
...
/* Use default crypto settings for Protected Storage */
#ifndef PS_DEFAULT_CRYPTO_CONFIG
...
/*
 * tfm_hal_finish_boot is called if this option is enabled.
 * It's called by SPM right before starting scheduler.
 */
#ifndef CONFIG_TFM_HAL_FINISH_BOOT
#define CONFIG_TFM_HAL_FINISH_BOOT              0
#endif

/*
 * Set to 1 in case the NS environment or integrators want to rename the API 
 * symbols exported by the TF-M Crypto service. This adds a default prefix 
 * tfm_crypto__. 
 */
#ifndef CONFIG_TFM_CRYPTO_API_RENAME
#define CONFIG_TFM_CRYPTO_API_RENAME           0
#endif
