...
set(MCUBOOT_GIT_REMOTE                  "https://github.com/mcu-tools/mcuboot.git"    CACHE STRING    "The URL (or path) to retrieve MCUboot from")
...
set(PLATFORM_EXCEPTION_INFO             OFF         CACHE BOOL      "Whether platform provides platform-specific exception info store/dump")
...
set(MBEDCRYPTO_PATCH_DIR                "${CMAKE_SOURCE_DIR}/lib/ext/mbedcrypto" CACHE STRING "Path to mbedtls patches")
