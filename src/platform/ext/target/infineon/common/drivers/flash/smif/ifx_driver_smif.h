...
#ifndef __IFX_DRIVER_SMIF_H__
#define __IFX_DRIVER_SMIF_H__
...
typedef struct ifx_driver_smif_mem_t {
    ...
    const cy_stc_smif_block_config_t *block_config; /**< SMIF block configuration used for Cy_SMIF_MemInit */
    const cy_stc_smif_mem_config_t *mem_config;  /**< SMIF memory configuration */
    const cy_stc_smif_mem_config_t *mem_config_dual_quad_pair;  /**< SMIF dual-quad pair memory configuration */
