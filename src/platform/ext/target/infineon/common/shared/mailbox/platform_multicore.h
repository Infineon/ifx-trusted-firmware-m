 ...
 */
int ifx_mailbox_fetch_msg_ptr(void **msg_ptr);
 ...
 * \retval else            The operation fails.
 */
int ifx_mailbox_fetch_msg_data(uint32_t *data_ptr);
 ...
 * \retval else            The operation fails.
 */
int ifx_mailbox_send_msg_ptr(const void *msg_ptr);
 ...
 * \retval else            The operation fails.
 */
int ifx_mailbox_send_msg_data(uint32_t data);
