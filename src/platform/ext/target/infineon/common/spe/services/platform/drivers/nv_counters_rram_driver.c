...
#define IFX_RRAM_NV_COUNTERS_ERASE_VALUE   IFX_DRIVER_RRAM_ERASE_VALUE

static const ifx_driver_rram_obj_t ifx_rram_obj_nv_counters = {
    .rram_base = IFX_RRAMC0,
    .start_address = IFX_RRAM_NV_COUNTERS_AREA_ADDR,
    .flash_info = {
        /* Sector layout information (NULL=Uniform sectors) */
        .sector_info  = NULL,

        .sector_count = IFX_RRAM_NV_COUNTERS_AREA_SIZE / IFX_RRAM_NV_COUNTERS_SECTOR_SIZE,

        /* Uniform sector size in bytes (0=sector_info used) */
        .sector_size  = IFX_RRAM_NV_COUNTERS_SECTOR_SIZE,
        /* Optimal programming page size in bytes */
        .page_size    = IFX_RRAM_NV_COUNTERS_SECTOR_SIZE,
        /* Smallest programmable unit in bytes */
        .program_unit = IFX_RRAM_NV_COUNTERS_PROGRAM_UNIT,
        /* Contents of erased memory (usually 0xFF) */
        .erased_value = IFX_RRAM_NV_COUNTERS_ERASE_VALUE,
    }
};
