...
#ifndef IFX_FLASH_NV_COUNTERS_SECTOR_SIZE
#error "Flash driver sector size (IFX_FLASH_NV_COUNTERS_SECTOR_SIZE) must be defined"
#endif
...
#define IFX_NUM_NV_COUNTERS  ((IFX_FLASH_NV_COUNTERS_SECTOR_SIZE - IFX_INIT_VALUE_SIZE - IFX_CHECKSUM_SIZE) / IFX_NV_COUNTER_SIZE)

#define IFX_NV_COUNTERS_INITIALIZED 0xC0DE0042U

#define IFX_FLASH_NV_COUNTERS_AREA_OFFSET   (0U)
#define IFX_FLASH_NV_COUNTERS_BACKUP_OFFSET (IFX_FLASH_NV_COUNTERS_AREA_OFFSET + IFX_FLASH_NV_COUNTERS_SECTOR_SIZE)
...
{
    bool valid = false;
    uint32_t checksum = ifx_se_crc32d6a(sizeof(nv_counters->nv_cnt.bytes), nv_counters->nv_cnt.bytes, IFX_NV_COUNTERS_CRC_INIT);
...
{
    nv_counters->checksum = ifx_se_crc32d6a(sizeof(nv_counters->nv_cnt.bytes), nv_counters->nv_cnt.bytes, IFX_NV_COUNTERS_CRC_INIT);
}
...
enum tfm_plat_err_t tfm_plat_init_nv_counter(void)
{
    ...
    ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.ReadData(IFX_FLASH_NV_COUNTERS_AREA_OFFSET,
                                                        &nv_counters,
                                                        sizeof(nv_counters));
    ...
    ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.ReadData(IFX_FLASH_NV_COUNTERS_BACKUP_OFFSET,
                                                        &nv_counters,
                                                        sizeof(nv_counters));
    if (ret < 0 || ret != (int32_t)sizeof(nv_counters)) {
        return TFM_PLAT_ERR_SYSTEM_ERR;
    ...
    ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.EraseSector(IFX_FLASH_NV_COUNTERS_AREA_OFFSET);
    if (ret != ARM_DRIVER_OK) {
        return TFM_PLAT_ERR_SYSTEM_ERR;
    }
    ...
    ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.ProgramData(IFX_FLASH_NV_COUNTERS_AREA_OFFSET,
                                                           &nv_counters,
                                                           sizeof(nv_counters));
    if (ret < 0 || ret != (int32_t)sizeof(nv_counters)) {
        return TFM_PLAT_ERR_SYSTEM_ERR;
                                             ...
                                             uint32_t size, uint8_t *val)
{
    ...
    uint32_t flash_addr = IFX_FLASH_NV_COUNTERS_AREA_OFFSET + \
                          offsetof(ifx_nv_counters_t, nv_cnt.counters) + \
                          (nv_counter_id * IFX_NV_COUNTER_SIZE);

    int32_t ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.ReadData(flash_addr, val, IFX_NV_COUNTER_SIZE);
                                            ...
                                            uint32_t value)
{
    ...
    int32_t ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.ReadData(IFX_FLASH_NV_COUNTERS_AREA_OFFSET,
                                                                &nv_counters,
                                                                sizeof(nv_counters));
    if (ret < 0 || ret != (int32_t)sizeof(nv_counters)) {
        return TFM_PLAT_ERR_SYSTEM_ERR;
    ...
    /* Erase backup sector */
    ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.EraseSector(IFX_FLASH_NV_COUNTERS_BACKUP_OFFSET);
    if (ret != ARM_DRIVER_OK) {
        return TFM_PLAT_ERR_SYSTEM_ERR;
    }
    ...
    ret = IFX_NV_COUNTERS_CMSIS_FLASH_INSTANCE.ProgramData(IFX_FLASH_NV_COUNTERS_BACKUP_OFFSET,
                                                           &nv_counters,
                                                           sizeof(nv_counters));
    if (ret < 0 || ret != (int32_t)sizeof(nv_counters)) {
        return TFM_PLAT_ERR_SYSTEM_ERR;
