 ...
 *
 * Use PSE84 EPC2 implementation of crypto_keys_rram.h as a reference.
 */
...
static enum tfm_plat_err_t ifx_plat_get_huk(uint8_t *buf, size_t buf_len,
                                            size_t *key_len,
...
static enum tfm_plat_err_t ifx_plat_get_iak_priv(uint8_t *buf, size_t buf_len,
                                                 size_t *key_len,
                                                 psa_key_bits_t *key_bits,
                                                 psa_algorithm_t *algorithm,
                                                 psa_key_type_t *type)
...
static enum tfm_plat_err_t ifx_plat_get_iak_pub(uint8_t *buf, size_t buf_len,
                                                size_t *key_len,
                                                psa_key_bits_t *key_bits,
                                                psa_algorithm_t *algorithm,
                                                psa_key_type_t *type)
