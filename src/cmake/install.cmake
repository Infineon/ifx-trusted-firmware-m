...
install(FILES       ${CMAKE_SOURCE_DIR}/lib/static_checks/static_checks.h
...
if (PLATFORM_NSID_IN_SHARED_DATA OR (TFM_PARTITION_NS_AGENT_MAILBOX AND TFM_NS_MANAGE_NSID))
    set(NS_CLIENT_EXT_DIR ${CMAKE_SOURCE_DIR}/secure_fw/spm/ns_client_ext)
    install(FILES       ${NS_CLIENT_EXT_DIR}/tfm_ns_ctx.h
                        ${NS_CLIENT_EXT_DIR}/tfm_ns_ctx_shm.h
                        ${CMAKE_SOURCE_DIR}/secure_fw/spm/include/tfm_exc_num.h
                        ${CMAKE_SOURCE_DIR}/secure_fw/spm/include/tfm_nspm.h
                        ${CMAKE_SOURCE_DIR}/secure_fw/include/security_defs.h
            DESTINATION ${INSTALL_INTERFACE_INC_DIR})
    install(FILES       ${NS_CLIENT_EXT_DIR}/tfm_ns_ctx.c
                        ${NS_CLIENT_EXT_DIR}/tfm_ns_client_ext.c
            DESTINATION ${INSTALL_INTERFACE_SRC_DIR})
    if (TFM_MULTI_CORE_TOPOLOGY)
        # The "read" interface is also needed in the NSPE of remote cores
        install(FILES       ${NS_CLIENT_EXT_DIR}/tfm_ns_ctx_s.c
...
if (TFM_PARTITION_CRYPTO)
    install(FILES       ${MBEDCRYPTO_PATH}/include/psa/build_info.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_adjust_auto_enabled.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_adjust_config_key_pair_types.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_adjust_config_synonyms.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_builtin_composites.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_builtin_key_derivation.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_builtin_primitives.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_compat.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_driver_common.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_driver_contexts_composites.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_driver_contexts_key_derivation.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_driver_contexts_primitives.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_extra.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_legacy.h
                        $<$<BOOL:${MBEDTLS_PSA_CRYPTO_PLATFORM_FILE}>:${MBEDTLS_PSA_CRYPTO_PLATFORM_FILE}>
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_platform.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_se_driver.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_sizes.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_struct.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_types.h
                        ${MBEDCRYPTO_PATH}/include/psa/crypto_values.h
            DESTINATION ${INSTALL_INTERFACE_INC_DIR}/psa)
    install(DIRECTORY   ${MBEDCRYPTO_PATH}/include/mbedtls
            DESTINATION ${INSTALL_INTERFACE_INC_DIR})
