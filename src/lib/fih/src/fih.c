...
const fih_int FIH_SUCCESS = FIH_INT_INIT(FIH_POSITIVE_VALUE);
const fih_int FIH_FAILURE = FIH_INT_INIT(FIH_NEGATIVE_VALUE);
const fih_int FIH_INVALID = FIH_INVALID_INIT;
#endif
