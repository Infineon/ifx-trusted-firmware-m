...
#define FIH_POSITIVE_VALUE    0x5555AAAAU
#define FIH_NEGATIVE_VALUE    0xAAAA5555U
 ...
 */
#define _FIH_MASK_VALUE       0xA5C35A3Cul
...
#define FIH_INVALID_INIT      { FIH_POSITIVE_VALUE, FIH_NEGATIVE_VALUE }
#else /* FIH_ENABLE_DOUBLE_VARS */
#define FIH_POSITIVE_VALUE    0x0
#define FIH_NEGATIVE_VALUE    0xAAAA5555U
#define FIH_INVALID_INIT      FIH_NEGATIVE_VALUE
...
extern const fih_int FIH_SUCCESS;
extern const fih_int FIH_FAILURE;
extern const fih_int FIH_INVALID;
...
#define FIH_INVALID           FIH_FAILURE
#define FIH_INVALID_INIT      FIH_INVALID
