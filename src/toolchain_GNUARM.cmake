...
add_compile_options(
    ...
    # Code coverage must be run without any optimizations
    $<$<BOOL:${TEST_NS_IFX_CODE_COVERAGE}>:-O0>
...
add_link_options(
    ...
    -specs=nano.specs
    -specs=nosys.specs
    $<$<BOOL:${TEST_NS_IFX_CODE_COVERAGE}>:-lgcov>
    $<$<BOOL:${TEST_NS_IFX_CODE_COVERAGE}>:--coverage>
