...
#if !defined(FLASH_DEV_NAME) && (!defined(FLASH_DEV_NAME_0) || \
                                 !defined(FLASH_DEV_NAME_1) || \
                                 !defined(FLASH_DEV_NAME_2) || \
                                 !defined(FLASH_DEV_NAME_3) || \
                                 !defined(FLASH_DEV_NAME_SCRATCH))
