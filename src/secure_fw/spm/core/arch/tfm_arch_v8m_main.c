...
#if CONFIG_TFM_SPM_BACKEND_IPC == 1
#if defined(__ICCARM__) && defined(PLATFORM_PENDSV_HANDLER_HOOK_IAR_REQUIRED)
PLATFORM_PENDSV_HANDLER_HOOK_IAR_REQUIRED
#endif /* __ICCARM__ && PLATFORM_PENDSV_HANDLER_EXIT_HOOK */
__attribute__((naked)) void PendSV_Handler(void)
{
    __ASM volatile(
        ...
        "   isb                                         \n"
        "v8m_pendsv_exit:                               \n"
#ifdef PLATFORM_PENDSV_HANDLER_EXIT_HOOK
        /*!
         * \brief Allows to implement platform specific switching logic
         *
         * \param r0    previous context
         * \param r1    current context
         * \param lr    exc_return
         **/
        PLATFORM_PENDSV_HANDLER_EXIT_HOOK
#else
        "   bx      lr                                  \n"
#endif
    );
...
#if defined(__ICCARM__)
#if defined(__ICCARM__) && defined(PLATFORM_SVC_HANDLER_HOOK_IAR_REQUIRED)
PLATFORM_SVC_HANDLER_HOOK_IAR_REQUIRED
#endif /* __ICCARM__ && PLATFORM_PENDSV_HANDLER_EXIT_HOOK */
#endif /* __ICCARM__ */
__attribute__((naked)) void SVC_Handler(void)
{
    __ASM volatile(
    SYNTAX_UNIFIED
#ifdef PLATFORM_SVC_HANDLER_GET_MSP_HOOK
    PLATFORM_SVC_HANDLER_GET_MSP_HOOK("r0")
#else
    "MRS     r0, MSP                         \n"
#endif
    "MOV     r1, lr                          \n"
    ...
    "ADD     sp, #16                         \n" /*
                                                  ...
                                                  */
#ifdef PLATFORM_SVC_HANDLER_EXIT_HOOK
    PLATFORM_SVC_HANDLER_EXIT_HOOK
#else
    "BX      lr                              \n"
#endif
    "to_flih_func:                           \n"
#ifdef PLATFORM_SVC_HANDLER_TO_FLIH_FUNC_ENTER_HOOK
    PLATFORM_SVC_HANDLER_TO_FLIH_FUNC_ENTER_HOOK
#endif
#if (CONFIG_TFM_FLOAT_ABI >= 1)
...
#ifdef PLATFORM_SVC_HANDLER_TO_FLIH_FUNC_EXIT_HOOK
    PLATFORM_SVC_HANDLER_TO_FLIH_FUNC_EXIT_HOOK
#else
    "BX      lr                              \n"
#endif
    "from_flih_func:                         \n"
    "ADD     sp, #16                         \n" /*
                                                  ...
                                                  * PSP, PSPLIM pushed by current handler
                                                  */
#ifdef PLATFORM_SVC_HANDLER_FROM_FLIH_FUNC_ENTER_HOOK
    PLATFORM_SVC_HANDLER_FROM_FLIH_FUNC_ENTER_HOOK
#endif
    "POP     {r4, r5}                        \n" /* Seal stack */
    "ANDS    r3, lr, #"M2S(EXC_RETURN_DCRS)" \n" /* Check DCRS */
    "ITT     ne                              \n" /* Skip loading callee */
    ...
    "ADD     sp, #16                         \n" /*
                                                  ...
                                                  */
#ifdef PLATFORM_SVC_HANDLER_FROM_FLIH_FUNC_EXIT_HOOK
    PLATFORM_SVC_HANDLER_FROM_FLIH_FUNC_EXIT_HOOK
#else
    "BX      lr                              \n"
#endif
    );
...
void tfm_arch_config_extensions(void)
{
     ...
     * if it is used
     */
    FIH_SET_REG(SCB->CPACR, (3U << 10U*2U)        /* enable CP10 full access for SPE */
                          | (3U << 11U*2U));      /* enable CP11 full access for SPE */
    FIH_SET_REG(SCB_NS->CPACR, (3U << 10U*2U)     /* enable CP10 full access for NSPE */
                             | (3U << 11U*2U));   /* enable CP11 full access for NSPE */
    __DSB();
    __ISB();

    /* Permit Non-secure access to the Floating-point Extension. */
    FIH_SET_REG(SCB->NSACR, SCB_NSACR_CP10_Msk | SCB_NSACR_CP11_Msk);
     ...
     */
    FIH_CLEAR_REG(SCB->CPACR, (3U << 10U*2U)        /* disable CP10 full access for SPE */
                            | (3U << 11U*2U));      /* disable CP11 full access for SPE */
    FIH_CLEAR_REG(SCB_NS->CPACR, (3U << 10U*2U)     /* disable CP10 full access for NSPE */
                               | (3U << 11U*2U));   /* disable CP11 full access for NSPE */
    __DSB();
    __ISB();

    /* Disable Non-secure access to the Floating-point Extension. */
    FIH_CLEAR_REG(SCB->NSACR, (SCB_NSACR_CP10_Msk | SCB_NSACR_CP11_Msk));
    ...
    FIH_SET_REG(FPU->FPCCR, FPU_FPCCR_LSPEN_Msk);
#else
    /* Disable lazy stacking. */
    FIH_CLEAR_REG(FPU->FPCCR, FPU_FPCCR_LSPEN_Msk);
#endif
    ...
    FIH_SET_REG(ICB->CPPWR, SCnSCB_CPPWR_SUS11_Msk | SCnSCB_CPPWR_SUS10_Msk);
#else
    FIH_SET_REG(SCnSCB->CPPWR, SCnSCB_CPPWR_SUS11_Msk | SCnSCB_CPPWR_SUS10_Msk);
#endif
#endif /* CONFIG_TFM_FLOAT_ABI >= 1 */

#if defined(__ARM_ARCH_8_1M_MAIN__) && (__ARM_ARCH_8_1M_MAIN__ == 1)
    FIH_SET_REG(SCB->CCR, SCB_CCR_TRD_Msk);
#endif
}
