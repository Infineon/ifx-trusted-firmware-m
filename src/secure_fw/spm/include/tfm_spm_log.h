...
#if (TFM_SPM_LOG_LEVEL == TFM_SPM_LOG_LEVEL_DEBUG)
#define SPMLOG_DBGMSGVAL(msg, val) (void)spm_log_msgval(msg, sizeof(msg), val)
#define SPMLOG_DBGMSG(msg) (void)tfm_hal_output_spm_log(msg, sizeof(msg))
#else
...
#define SPMLOG_INFMSGVAL(msg, val) (void)spm_log_msgval(msg, sizeof(msg), val)
#define SPMLOG_INFMSG(msg) (void)tfm_hal_output_spm_log(msg, sizeof(msg))
#else
...
#define SPMLOG_ERRMSGVAL(msg, val) (void)spm_log_msgval(msg, sizeof(msg), val)
#define SPMLOG_ERRMSG(msg) (void)tfm_hal_output_spm_log(msg, sizeof(msg))
#else
